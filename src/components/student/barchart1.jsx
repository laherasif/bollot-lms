import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend,Cell,Pie,PieChart , ReferenceLine,BarChart,Bar, ResponsiveContainer } from 'recharts';
  ...
  return (
    <ResponsiveContainer width="99%"   aspect={2}  >
      ...
      >
          ...
          <Bar radius={[5, 5, 5, 5]} className='ksldjafds-dsfads' dataKey="uv" barSize={14} fill="#8884d8" >
          {
