      ...
      <div className="navBar-cst">
        ...
        <section className="container-3 my-5 hsajdk-sadnwi">
          <div className="row">
            ...
            <div className="col-md-6">
              <Image className="images-2" src={CardImage} alt="image_tag" />
            </div>
          </div>
        ...
        <section className="jadsiw0ds-adwdmd sakdis-a3ne">
          <div className="container-3">
...
Lorem Ipsum is simply dummy text of the printing and typesetting industry. " color={1} btext="Register as Student"/>
...
Lorem Ipsum is simply dummy text of the printing and typesetting industry. " color={2} btext="Register as Teacher"/>
...
Lorem Ipsum is simply dummy text of the printing and typesetting industry. " color={3} btext="Register as Company"/>
          </div>
